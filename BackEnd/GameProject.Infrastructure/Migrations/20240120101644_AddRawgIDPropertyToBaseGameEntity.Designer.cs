...
namespace GameProject.Identity.Migrations
{
    ...
    [Migration("20240120101644_AddRawgIDPropertyToBaseGameEntity")]
    partial class AddRawgIDPropertyToBaseGameEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameProject.Infrastructure.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GameProject.Infrastructure.Models.ProfilePhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GameProject.Domain.Models.Shared.UsersAbandonedGames", b =>
                {
                    ...
                    b.HasOne("GameProject.Infrastructure.Models.ApplicationUser", "User")
                        .WithMany("UsersAbandonedGames")
            ...
            modelBuilder.Entity("GameProject.Infrastructure.Models.ProfilePhoto", b =>
                {
                    b.HasOne("GameProject.Infrastructure.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("GameProject.Infrastructure.Models.ProfilePhoto", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("GameProject.Infrastructure.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
